...
# Example usage
base_directory = "/Users/nicom/Documents/Portfolio-v2/src"  # Change this to the path of your codebase
output_file_name = "consolidated_code.xml"  # The name of the output file
file_types_to_include = ['.py', '.ts','.tsx','.js','Dockerfile', '.yaml','.html',]  # Change this list based on the types of files you want to include
directories_to_ignore = ['node_modules','build' ]  # Directories to ignore
